...
<body>
    ...
    <div class="container">
        ...
        <div class="wp-0-container">
            <a href="/Upick/web/wepick/wepick-1-document.php"
                class="col-lg-3 col-sm-12 wp-document-hover wp-originStyle text-center">
                <div class="wp-img">
            ...
            <a href="/Upick/web/wepick/wepick-1-design.php"
                class="col-lg-3 col-sm-12 wp-design-hover wp-originStyle text-center">
                <div class="wp-img">
            ...
            <a href="/Upick/web/wepick/wepick-1-editing.php"
                class="col-lg-3 col-sm-12 wp-editing-hover wp-originStyle text-center">
                <div class="wp-img">
            ...
            <a href="/Upick/web/wepick/wepick-1-gaming.php"
                class="col-lg-3 col-sm-12 wp-gaming-hover wp-originStyle text-center">
                <div class="wp-img">
